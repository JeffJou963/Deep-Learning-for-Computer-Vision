...
if __name__ == '__main__':
	...
	default_folder = './pb1_output/alldigits_loss0.016_seed1'
	# default_folder = './pb1_output/alldigits_loss0.015'
	parser = argparse.ArgumentParser()
	parser.add_argument("--folder", help="path to the folder for output images", type=str, default=default_folder)
