...
def eval_clip(pred_file, images_root):
    # Read data
...
def eval(pred_file, images_root, annotation_file):
    ...
    # pred_keys_list = list(predictions.keys())
    # gt_keys_list = list(gts.keys())
    # print("Predictions keys:", pred_keys_list[:10])
    # print("Ground truth keys:", gt_keys_list[:10])
...
if __name__ == "__main__":
    ...
    parser.add_argument("--pred_file", default='/home/remote/yichou/DLCV/dlcv-fall-2023-hw3-JeffJou963/hw3_data/output_p2/pred.json')
    parser.add_argument("--images_root", default="/home/remote/yichou/DLCV/dlcv-fall-2023-hw3-JeffJou963/hw3_data/p2_data/images/val")
    parser.add_argument("--annotation_file", default="/home/remote/yichou/DLCV/dlcv-fall-2023-hw3-JeffJou963/hw3_data/p2_data/val.json")
