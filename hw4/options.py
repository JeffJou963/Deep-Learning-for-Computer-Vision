...
def get_options():
    ...
    parser.add_argument('--dataset_name', type=str, default='Klevr', choices=['blender', 'llff'], help='which dataset to train/val')
    ...
    # parser.add_argument('--N_samples', type=int, default=16, help='number of coarse samples')
    ...
    # parser.add_argument('--noise_std', type=float, default=0.0, help='std dev of noise added to regularize sigma')
    ...
    parser.add_argument('--lr_scheduler', type=str, default='steplr', choices=['steplr', 'cosine', 'poly'])
    ...
    parser.add_argument('--exp_name', type=str, default='exp_1211', help='experiment name')
